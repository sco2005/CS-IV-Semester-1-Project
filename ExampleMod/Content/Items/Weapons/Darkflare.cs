...
namespace ExampleMod.Content.Items.Weapons
{
	...
	internal class Darkflare : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 900; // The damage of your flail, this is dynamically adjusted in the projectile code.
			Item.crit = 15; // Critical damage chance %
			Item.scale = 1.1f;
